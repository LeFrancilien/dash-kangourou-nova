...
import { MoreHorizontalIcon, TrendingUpIcon, TrendingDownIcon, ChevronDownIcon, PlusIcon, ChevronsLeftIcon, ChevronLeftIcon, ChevronRightIcon, ChevronsRightIcon, GripVerticalIcon, CheckCircle2Icon, LoaderIcon, MoreVerticalIcon, FileTextIcon, PhoneIcon, MailIcon, AlertCircleIcon } from "lucide-react"
...
// Exported function deleted - now using individual exports below
  ...
  return (
    <div className="*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-1 gap-4 px-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs lg:px-6 @xl/main:grid-cols-2 @5xl/main:grid-cols-4">
      <Card className="@container/card">
        <CardHeader>
          <CardDescription>Devis aujourd'hui</CardDescription>
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
            {stats.devisAujourdhui}
          </CardTitle>
          <CardAction>
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          <div className="text-muted-foreground">Devis créés ce jour</div>
        </CardFooter>
      </Card>
      <Card className="@container/card">
        <CardHeader>
          <CardDescription>Relances J+2</CardDescription>
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
            {stats.devisJ2}
          </CardTitle>
          <CardAction>
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          <div className="text-muted-foreground">Devis sans réponse à relancer</div>
        </CardFooter>
      </Card>
      <Card className="@container/card">
        <CardHeader>
          <CardDescription>Emails J+4</CardDescription>
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
            {stats.emailsJ4}
          </CardTitle>
          <CardAction>
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          <div className="text-muted-foreground">Emails automatiques à envoyer</div>
        </CardFooter>
      </Card>
      <Card className="@container/card">
        <CardHeader>
          <CardDescription>Taux conversion</CardDescription>
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          <div className="text-muted-foreground">Sur les 30 derniers jours</div>
        </CardFooter>
      </Card>
    </div>
  )
...
const columns: ColumnDef<z.infer<typeof schema>>[] = [
  ...
  {
    accessorKey: "target",
    header: () => <div className="w-full text-right">Objectif</div>,
    cell: ({ row }) => (
      <form
        onSubmit={(e) => {
          e.preventDefault()
...
export function DataTable({ data: initialData = data }: { data?: z.infer<typeof schema>[] }) {
      ...
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <Select defaultValue="outline">
          ...
          <SelectContent>
            ...
            <SelectItem value="focus-documents">Documents prioritaires</SelectItem>
          </SelectContent>
        </Select>
        <TabsList className="**:data-[slot=badge]:bg-muted-foreground/30 hidden **:data-[slot=badge]:size-5 **:data-[slot=badge]:rounded-full **:data-[slot=badge]:px-1 @4xl/main:flex">
          ...
          <TabsTrigger value="focus-documents">Documents prioritaires</TabsTrigger>
        </TabsList>
